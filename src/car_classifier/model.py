...
class MultiLabelCarClassifier(nn.Module):
    ...
    def __init__(self, backbone: str = 'resnet50', num_classes: Dict[str, int] = None,
...
class MultiLabelLoss(nn.Module):
    ...
    def __init__(self, loss_weights: Optional[Dict[str, float]] = None):
        ...
        self.loss_weights = loss_weights or {'make': 1.0, 'model': 1.0, 'steer_wheel': 1.0}
...
def create_model(backbone: str = 'resnet50', num_classes: Dict[str, int] = None,
                 pretrained: bool = True, dropout_rate: float = 0.5) -> MultiLabelCarClassifier:
    """
